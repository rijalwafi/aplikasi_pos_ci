...
class C_satuan extends CI_Controller {
    ...
    public function simpan()
    {
        ...
        $insert = $this->M_satuan->insert_satuan($set_data);
    ...
    public function get_data($id_satuan)
    {
        $get = $this->M_satuan->get_id_satuan($id_satuan);
        if($get){
    ...
    public function rubah()
    {
        ...
        $update = $this->M_satuan->update_satuan($set_data,$post['id_satuan']);
        if($update){
    ...
    {
        $hapus = $this->M_satuan->del_satuan($id_satuan);
        if($hapus){
            redirect('satuan');
        }else{
            redirect('satuan');
